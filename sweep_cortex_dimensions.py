...
if __name__ == '__main__':
    ...
    log_file = open('ctx_params_sweep_350patterns_480.txt', 'w')
    log_txt = '# n_hc, n_mc, vq_overlap, correct_trials.mean(), correct_trials.mean() / n_patterns,  correct_trials.std() / n_patterns\tn_dim_mds\n'
...
#    mit_response_normalized_fn = 'Cluster_SparserObPatterns_nGlom40_nHC9_nMC9_vqOvrlp8_ORnoise0.0_OrAffNorm0_postL_np50_1_OcOnly/NumberOfSpikes/mit_response_normalized_np50'
    ...
    mit_response_normalized_fn = 'Cluster_trainingWithNoisyPatterns_nGlom40_nHC12_nMC30_vqOvrlp4_np350_OcOnly/NumberOfSpikes/mit_response_normalized_np350'


    n_patterns_total = 350
    n_patterns = 50
...
#    n_hc_mc = [(6, 60)]
    ...
    n_hc_mc = [(3, 160), (4, 120), (5, 96), (6, 80), (8, 60), (10, 48), (12, 40), (16, 30), (20, 24), \
            (24, 20), (30, 16), (40, 12), (48, 10), (60, 8), (80, 6), (96, 5), (120, 4), (160, 3)]
...
#                ObOc.mds_vq_ob_output(params, mds_output_fn)
    ...
    #            wta_output_fn = output_fn.rsplit('.dat')[0] + '_wta.dat'
            ...
            log_txt = '%d\t%d\t%d\t%.2f\t%.2f\t%.2f\t%d\n' % (n_hc, n_mc, vq_overlap, correct_trials.mean(), correct_trials.mean() / float(params['n_patterns']) * 100., correct_trials.std() / float(params['n_patterns']) * 100., params['n_dim_mds'])
