	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 cad /home/bernhard/workspace/olfactory_system/OlfactorySystem/neuron_files/x86_64/cadecay.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 54 in file cadecay.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
