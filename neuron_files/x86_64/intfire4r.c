...
#define E E_IntFire4r
#define I I_IntFire4r
#define M M_IntFire4r
#define deriv deriv_IntFire4r
#define firetimebound firetimebound_IntFire4r
#define search search_IntFire4r
 extern double E();
 extern double I();
 extern double M();
 extern double deriv();
...
#define eps eps_IntFire4r
 double eps = 1e-06;
#define ib ib_IntFire4r
 double ib = 0;
#define taueps taueps_IntFire4r
 double taueps = 0.01;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "eps_IntFire4r", 1e-09, 0.01,
 "taueps_IntFire4r", 1e-09, 1e+09,
 "taum", 0, 1e+09,
 "taui2", 0, 1e+09,
 "taui1", 0, 1e+09,
 "taue", 0, 1e+09,
 ...
 "ib_IntFire4r", &ib_IntFire4r,
 "eps_IntFire4r", &eps_IntFire4r,
 "taueps_IntFire4r", &taueps_IntFire4r,
 0,0
};
...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 IntFire4r /home/bernhard/workspace/olfactory_system/OlfactorySystem/neuron_files/x86_64/intfire4r.mod\n");
