...
extern int nrn_get_mechtype();
 ...
 "setdata_cadecay_destexhe", _hoc_setdata,
 0, 0
};
 ...
 "depth_cadecay_destexhe", "um",
 "taur_cadecay_destexhe", "ms",
 "cainf_cadecay_destexhe", "mM",
 "kt_cadecay_destexhe", "mM/ms",
 "kd_cadecay_destexhe", "mM",
 0,0
};
...
#define _cvode_ieq _ppvar[3]._i
 ...
 "6.2.0",
"cadecay_destexhe",
 "depth_cadecay_destexhe",
 "taur_cadecay_destexhe",
 "cainf_cadecay_destexhe",
 "kt_cadecay_destexhe",
 "kd_cadecay_destexhe",
 0,
 0,
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 cadecay_destexhe /home/bernhard/workspace/olfactory_system/OlfactorySystem/neuron_files/x86_64/cadecay_destexhe.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 65 in file cadecay_destexhe.mod:\n	SOLVE state METHOD euler\n"); nrn_complain(_p); abort_run(error);}
