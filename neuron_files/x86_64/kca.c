...
extern int nrn_get_mechtype();
 ...
 "concdep_kca", _hoc_concdep,
 "rate_kca", _hoc_rate,
 "vdep_kca", _hoc_vdep,
 0, 0
};
 /* declare global and static user variables */
#define Ybeta Ybeta_kca
 double Ybeta = 0.05;
#define Yalpha Yalpha_kca
 double Yalpha = 0;
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 kca /home/bernhard/workspace/olfactory_system/OlfactorySystem/neuron_files/x86_64/kca.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 50 in file kca.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
