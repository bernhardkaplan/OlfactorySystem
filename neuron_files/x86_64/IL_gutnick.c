	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ical /home/bernhard/workspace/olfactory_system/OlfactorySystem/neuron_files/x86_64/IL_gutnick.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 103 in file IL_gutnick.mod:\n	SOLVE states METHOD euler\n"); nrn_complain(_p); abort_run(error);}
