...
extern int nrn_get_mechtype();
 ...
 "setdata_cagk2", _hoc_setdata,
 "alp_cagk2", _hoc_alp,
 "bet_cagk2", _hoc_bet,
 "exp1_cagk2", _hoc_exp1,
 "rate_cagk2", _hoc_rate,
 0, 0
};
#define alp alp_cagk2
#define bet bet_cagk2
#define exp1 exp1_cagk2
 extern double alp();
 extern double bet();
 extern double exp1();
 /* declare global and static user variables */
#define abar abar_cagk2
 double abar = 0.48;
#define bbar bbar_cagk2
 double bbar = 0.28;
#define d2 d2_cagk2
 double d2 = 1;
#define d1 d1_cagk2
...
#define k1 k1_cagk2
 double k1 = 0.18;
#define oinf oinf_cagk2
 double oinf = 0;
#define tau tau_cagk2
 double tau = 0;
 ...
 "k1_cagk2", &k1_cagk2,
 "k2_cagk2", &k2_cagk2,
 "bbar_cagk2", &bbar_cagk2,
 "abar_cagk2", &abar_cagk2,
 "oinf_cagk2", &oinf_cagk2,
 "tau_cagk2", &tau_cagk2,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 cagk2 /home/bernhard/workspace/olfactory_system/OlfactorySystem/neuron_files/x86_64/cagk2.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 46 in file cagk2.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
