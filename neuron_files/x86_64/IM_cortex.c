	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 im /home/bernhard/workspace/olfactory_system/OlfactorySystem/neuron_files/x86_64/IM_cortex.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 59 in file IM_cortex.mod:\n	SOLVE states METHOD euler\n"); nrn_complain(_p); abort_run(error);}
